    ...
    <body>
        ...
        <form action="be_output.php" method="post" enctype="multipart/form-data">
            <table style="width: 80%;">
                <tr>
                    <td colspan="3"><h3 align="center">Masukan Data Minuman</h3></td>
                </tr>
                <tr>
                    <td>No Minuman</td><td>:</td><td><input type="text" name="nomor" size="15"></td>
                </tr>
                <tr>
                    <td>Nama Minuman</td><td>:</td><td><input type="text" name="nama" size="30"></td>
                </tr>
                <tr>
