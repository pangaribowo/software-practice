...
<html>
    ...
    <form action="action_form.php" method="post" enctype="multipart/form-data">
        <table style="width: 80%;">
            <tr>
                <td colspan="3"><h3 align="center">Info Makanan</h3></td>
            </tr>
            <tr>
                <td>Nomor</td><td>:</td><td><?php echo $nomor;?></td>
            </tr>
            <tr>
                <td>Nama Makanan</td><td>:</td><td><?php echo $nama;?></td>
            </tr>
            <tr>
...
$sql = "INSERT INTO Makanan(kd_makanan, nm_makanan, bahan_makanan, foto_makanan) 
